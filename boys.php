...
<body>
  ...
  <section class="trending-product" id="trending">
    <div class="center-text">
      <br>
      <br>
      <h2>BOYS <span>UNIFORM</span></h2>
    </div>
    <div class="products">
      <div class="row">
        <img src="ImagesB/p10.jpg" alt="">
        ...
        <div class="cart">
          <a href="newcart.html"><i class='bx bxs-cart' ></i></a>
        </div>
        <div class="rating">
      ...
      <div class="row">
        ...
        <div class="cart">
          <a href="cart2.html"><i class='bx bxs-cart' ></i></a>
        </div>
        <div class="rating">
          <i class='bx bxs-star' ></i>
          <i class='bx bxs-star' ></i>
      ...
      <div class="row">
        <img src="ImagesB/portrait-young-man-standing-park_1048944-3474484.jpg" alt="">
        
        <div class="heart-icon">
          <i class='bx bx-heart' ></i>
        </div>
        <div class="cart">
          <a href="cart3.html"><i class='bx bxs-cart' ></i></a>
        </div>
        <div class="rating">
          <i class='bx bxs-star' ></i>
          <i class='bx bxs-star' ></i>
      ...
      <div class="row">
        ...
        <div class="cart">
          <a href="cart4.html"><i class='bx bxs-cart' ></i></a>
        </div>
        <div class="rating">
          <i class='bx bxs-star' ></i>
          <i class='bx bxs-star' ></i>
      ...
      <div class="row">
        <img src="ImagesB/p5.jpg" alt="">
        
        <div class="heart-icon">
          <i class='bx bx-heart' ></i>
        </div>
        <div class="cart">
          <a href="cart5.html"><i class='bx bxs-cart' ></i></a>
        </div>
        <div class="rating">
          <i class='bx bxs-star' ></i>
          <i class='bx bxs-star' ></i>
      ...
      <div class="row">
        ...
        <div class="price">
          <h4>Printed skirts</h4>
          <p>$9-$129</p>
        </div>
      </div>

      <div class="row">
        <img src="ImagesB/p8.jpg" alt="">
        <div class="product-text">
          <h5>Sale</h5>
        </div>
        <div class="heart-icon">
